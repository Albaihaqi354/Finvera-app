...
export default function MobilePage() {
  return (
    <div className="flex flex-col h-[calc(100vh-140px)] space-y-6">
      ...
      <div className="bg-surface rounded-3xl shadow-sm border border-brand-black/5 flex-1 p-8 flex flex-col items-center justify-center text-center max-w-lg mx-auto w-full">
        <div className="w-20 h-20 rounded-2xl bg-base-light flex items-center justify-center mb-6">
        ...
        <div className="w-40 h-40 rounded-2xl border-2 border-dashed border-brand-black/15 flex items-center justify-center bg-base-light mb-4">
