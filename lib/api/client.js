...
export const api = {
  ...
  accounts: {
    getAll:  (params = {}) => {
      ...
      return fetchApi(query ? `/accounts?${query}` : '/accounts');
    },
  ...
  categories: {
    getAll:  (params = {}) => {
      const query = new URLSearchParams(params).toString();
      return fetchApi(query ? `/categories?${query}` : '/categories');
    },
  ...
  tags: {
    getAll:  (params = {}) => {
      const query = new URLSearchParams(params).toString();
      return fetchApi(query ? `/tags?${query}` : '/tags');
    },
  ...
  scheduled: {
    getAll:  (params = {}) => {
      const query = new URLSearchParams(params).toString();
      return fetchApi(query ? `/scheduled?${query}` : '/scheduled');
    },
